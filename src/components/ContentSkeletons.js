...
export default function ContentSkeletons({ height = 150, isWhite }) {
    ...
    useEffect(() => {
        Animated.loop(
            Animated.timing(animatedBGValue, { toValue: 1, duration: 1200, easing: Easing.linear.inOut, useNativeDriver: true })
        ).start()
    })
