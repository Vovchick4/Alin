...
export default function Reserv({ navigation, route }: any) {
    ...
    function onScrollHeaderTitle(event: any) {
            ...
            <View>
                <Container>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                        {route.params.data.price && route.params.data.price.map((price: any, i: number) => (
